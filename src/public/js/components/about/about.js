          ...
          <div className="of-grid-container">
            ...
            <div className="of-row">
              <div className="col-8">
                ...
                <p>All fonts are distributed under an open-source license and are free to use. Every font provides you with a link to its open-source hosted project, direct download and the site where it was initially found or published.</p>
