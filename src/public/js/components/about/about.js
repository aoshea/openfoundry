          ...
          <div className="of-grid-container">
            ...
            <div className="of-row">
              <div className="col-8">
                ...
                <p>Our solution is to offer a carefully controlled number of fonts in the most clear and dynamic way possible. Instead of overwhelming the user, open-foundry provides enough interest and excitement to encourage further exploration.</p>

                <p>All fonts are distributed under an open-source license and are free to use. Every font provides you with a link to its open-source hosted project, direct download and the site where it was initially found or published. All images used can be found on <a href="commons.wikimedia.org">Wikimedia Commons</a>.</p>
